...
required to run a [Timelord](https://github.com/WheatNetwork/wheat-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/WheatNetwork/wheat-blockchain/blob/main/install-timelord.sh)
