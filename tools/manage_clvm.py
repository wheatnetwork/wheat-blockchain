...
root = here.parent
cache_path = root.joinpath(".wheat_cache", "manage_clvm.json")
...
from wheat.types.blockchain_format.serialized_program import SerializedProgram  # noqa: E402
...
top_levels = {"wheat"}
hashes_path = root.joinpath("wheat/wallet/puzzles/deployed_puzzle_hashes.json")
std_libraries = root.joinpath("wheat/wallet/puzzles")
...
main(auto_envvar_prefix="WHEAT_MANAGE_CLVM")
