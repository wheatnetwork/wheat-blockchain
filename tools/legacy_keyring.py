"""
Provides a helper to access the legacy keyring which was supported up to version 1.6.1 of wheat-blockchain. To use this
...
from wheat.util.errors import KeychainUserNotFound
from wheat.util.keychain import KeyData, KeyDataSecrets, get_private_key_user
