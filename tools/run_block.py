...
"""
run_block: Convert an encoded FullBlock from the Wheat blockchain into a list of transactions

As input, takes a file containing a [FullBlock](../wheat/types/full_block.py) in json format
...
$ca_root is the directory containing your current Wheat config files
$hash is the header_hash of the [BlockRecord](../wheat/consensus/block_record.py)
...
The information for each spend is an "NPC" (Name, Puzzle, Condition):
        ...
        "conditions": a list of condition expressions, as in [condition_opcodes.py](../wheat/types/condition_opcodes.py)
