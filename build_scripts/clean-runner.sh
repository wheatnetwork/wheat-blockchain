...
rm -rf ../venv || true
rm -rf venv || true
rm -rf wheat_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf wheat-blockchain-gui/build || true
rm -rf wheat-blockchain-gui/daemon || true
rm -rf wheat-blockchain-gui/node_modules || true
rm wheat-blockchain-gui/temp.json || true
( cd "$PWD/wheat-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
...
npm uninstall -g @wheat-network/notarize-cli || true
