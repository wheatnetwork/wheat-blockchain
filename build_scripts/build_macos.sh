...
if [ "$NOTARIZE" == true ]; then
  electron-osx-sign Wheat-darwin-x64/Wheat.app --platform=darwin \
...
mv Wheat-darwin-x64 ../../../build_scripts/dist/
cd ../../../build_scripts || exit

DMG_NAME="Wheat-$WHEAT_INSTALLER_VERSION.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
NODE_PATH=./npm_macos/node_modules node build_dmg.js dist/Wheat-darwin-x64/Wheat.app $WHEAT_INSTALLER_VERSION
LAST_EXIT_CODE=$?
if [ "$LAST_EXIT_CODE" -ne 0 ]; then
