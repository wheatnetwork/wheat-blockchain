...
from wheat.plot_sync.exceptions import AlreadyStartedError, InvalidConnectionTypeError
from wheat.plot_sync.util import Constants
from wheat.plotting.manager import PlotManager
from wheat.plotting.util import HarvestingMode, PlotInfo
...
class Sender:
    ...
    _connection: Optional[WSWheatConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSWheatConnection) -> None:
