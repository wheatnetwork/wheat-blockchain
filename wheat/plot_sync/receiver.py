...
from wheat.consensus.pos_quality import UI_ACTUAL_SPACE_CONSTANT_FACTOR, _expected_plot_size
from wheat.plot_sync.delta import Delta, PathListDelta, PlotListDelta
from wheat.plot_sync.exceptions import (
...
from wheat.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
from wheat.plotting.util import HarvestingMode
...
from wheat.util.misc import get_list_or_len
...
class Receiver:
    ...
    def connection(self) -> WSWheatConnection:
