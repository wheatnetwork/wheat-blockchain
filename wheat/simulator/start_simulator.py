...
from wheat.server.start_service import Service, async_run
...
from wheat.simulator.simulator_full_node_rpc_api import SimulatorFullNodeRpcApi
...
from wheat.util.config import load_config, load_config_cli, override_config
...
async def async_main(
    ...
    if "simulator" in config:
        ...
        overrides = {
            ...
            "full_node.introducer_peer": {"host": "127.0.0.1", "port": 23333},
        }
