...
from wheat.cmds.init_funcs import init
from wheat.consensus.constants import ConsensusConstants
from wheat.daemon.server import WebSocketServer, daemon_launch_lock_path
from wheat.farmer.farmer import Farmer
from wheat.farmer.farmer_api import FarmerAPI
from wheat.full_node.full_node import FullNode
from wheat.full_node.full_node_api import FullNodeAPI
from wheat.harvester.harvester import Harvester
from wheat.harvester.harvester_api import HarvesterAPI
from wheat.introducer.introducer import Introducer
from wheat.introducer.introducer_api import IntroducerAPI
from wheat.protocols.shared_protocol import Capability, capabilities
from wheat.seeder.crawler import Crawler
from wheat.seeder.crawler_api import CrawlerAPI
from wheat.seeder.dns_server import DNSServer, create_dns_server_service
from wheat.seeder.start_crawler import create_full_node_crawler_service
from wheat.server.outbound_message import NodeType
from wheat.server.start_farmer import create_farmer_service
from wheat.server.start_full_node import create_full_node_service
from wheat.server.start_harvester import create_harvester_service
from wheat.server.start_introducer import create_introducer_service
from wheat.server.start_service import Service
from wheat.server.start_timelord import create_timelord_service
from wheat.server.start_wallet import create_wallet_service
from wheat.simulator.block_tools import BlockTools, test_constants
from wheat.simulator.full_node_simulator import FullNodeSimulator
from wheat.simulator.keyring import TempKeyring
from wheat.simulator.ssl_certs import get_next_nodes_certs_and_keys, get_next_private_ca_cert_and_key
from wheat.simulator.start_simulator import create_full_node_simulator_service
from wheat.ssl.create_ssl import create_all_ssl
from wheat.timelord.timelord import Timelord
from wheat.timelord.timelord_api import TimelordAPI
from wheat.timelord.timelord_launcher import VDFClientProcessMgr, find_vdf_client, spawn_process
from wheat.types.blockchain_format.sized_bytes import bytes32
from wheat.types.peer_info import UnresolvedPeerInfo
from wheat.util.bech32m import encode_puzzle_hash
from wheat.util.config import config_path_for_filename, load_config, lock_and_load_config, save_config, set_peer_info
from wheat.util.db_wrapper import generate_in_memory_db_uri
from wheat.util.ints import uint16
from wheat.util.keychain import bytes_to_mnemonic
from wheat.util.lock import Lockfile
from wheat.util.misc import SignalHandlers
from wheat.wallet.wallet_node import WalletNode
from wheat.wallet.wallet_node_api import WalletNodeAPI
...
async def setup_crawler(
    ...
    service_config["other_peers_port"] = 23333
...
async def setup_wallet_node(
    ...
    with TempKeyring(populate=True) as keychain:
        ...
        service_config["wheat_spam_amount"] = wheat_spam_amount
...
async def setup_farmer(
    ...
    service_config["wheat_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "wheat")
    service_config["pool_public_keys"] = [bytes(pk).hex() for pk in b_tools.pool_pubkeys]
    service_config["port"] = port
    service_config["rpc_port"] = uint16(0)
    config_pool["wheat_target_address"] = encode_puzzle_hash(b_tools.pool_ph, "wheat")
