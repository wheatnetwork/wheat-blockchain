...
from wheat.daemon.server import singleton, service_launch_lock_path
...
from wheat.rpc.rpc_server import start_rpc_server
...
class Service:
    def __init__(
        ...
        proctitle_name = f"wheat_{service_name_prefix}{service_name}"
