...
from wheat.protocols import full_node_protocol, introducer_protocol
...
from wheat.types.peer_info import PeerInfo, TimestampedPeerInfo
...
class FullNodeDiscovery:
    ...
    async def on_connect(self, peer: ws.WSWheatConnection):
        if (
    ...
    async def update_peer_timestamp_on_message(self, peer: ws.WSWheatConnection):
        if (
            peer.is_outbound
            and peer.peer_server_port is not None
            and peer.connection_type is NodeType.FULL_NODE
    ...
    async def _introducer_client(self):
        ...
        async def on_connect(peer: ws.WSWheatConnection):
    ...
    async def on_connect_callback(self, peer: ws.WSWheatConnection):
