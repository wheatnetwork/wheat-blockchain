...
from wheat.consensus.full_block_to_block_record import header_block_to_sub_block_record
...
from wheat.util.streamable import dataclass_from_dict, recurse_jsonify

log = logging.getLogger(__name__)


def _create_shutdown_file() -> IO:
    return tempfile.NamedTemporaryFile(prefix="wheat_full_node_weight_proof_handler_executor_shutdown_trigger")
