...
from wheat.consensus.blockchain import Blockchain, ReceiveBlockResult
...
from wheat.util.db_version import lookup_db_version
...
class FullNode:
    ...
    async def sync_from_fork_point(
        ...
        async def fetch_block_batches(batch_queue, peers_with_peak: List[ws.WSWheatConnection]):
            try:
        ...
        batch_queue: asyncio.Queue[Tuple[ws.WSWheatConnection, List[FullBlock]]] = asyncio.Queue(
