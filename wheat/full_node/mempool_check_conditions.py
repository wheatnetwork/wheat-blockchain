...
from wheat.full_node.generator import create_generator_args, setup_generator_args
from wheat.types.blockchain_format.coin import Coin
from wheat.types.blockchain_format.program import NIL
...
from wheat.util.clvm import int_from_bytes, int_to_bytes
from wheat.util.condition_tools import ConditionOpcode, conditions_by_opcode
from wheat.util.errors import Err, ValidationError
from wheat.util.ints import uint32, uint64, uint16
from wheat.wallet.puzzles.generator_loader import GENERATOR_FOR_SINGLE_COIN_MOD
from wheat.wallet.puzzles.rom_bootstrap_generator import get_generator
...
def parse_aggsig(args: SExp) -> List[bytes]:
    ...
    # just like as_atom_list() (see wheat/types/blockchain_format/program.py)
