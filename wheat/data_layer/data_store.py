...
from wheat.data_layer.data_layer_errors import KeyNotFoundError, NodeHashError, TreeGenerationIncrementingError
...
class DataStore:
    ...
    async def _insert_terminal_node(self, key: bytes, value: bytes) -> bytes32:
        ...
        # https://github.com/Wheat-Network/clvm/pull/102
        # https://github.com/Wheat-Network/clvm/pull/106
