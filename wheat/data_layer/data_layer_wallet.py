...
class DataLayerWallet:
    ...
    async def delete_mirror(
        self, mirror_id: bytes32, peer: WSWheatConnection, fee: uint64 = uint64(0)
    ) -> List[TransactionRecord]:
        ...
        if excess_fee > 0:
            wheat_tx: TransactionRecord = await self.wallet_state_manager.main_wallet.generate_signed_transaction(
                uint64(1),
                new_puzhash,
