...
from wheat.pools.pool_config import PoolWalletConfig, load_pool_config, add_auth_key
...
from wheat.util.config import get_config_lock, load_config, save_config, config_path_for_filename
...
class Farmer:
    ...
    async def get_cached_harvesters(self, connection: WSWheatConnection) -> HarvesterCacheEntry:
