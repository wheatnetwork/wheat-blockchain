...
class SigningMode(Enum):
    ...
    # CHIP-0002 signs the result of sha256tree(cons("Wheat Signed Message", message)) using the
    ...
    # Standard BLS signatures used by Wheat use the BLS message augmentation scheme
