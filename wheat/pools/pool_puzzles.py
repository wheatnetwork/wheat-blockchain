...
POOL_WAITING_ROOM_MOD = load_clvm_maybe_recompile(
    "pool_waitingroom_innerpuz.clsp", package_or_requirement="wheat.pools.puzzles"
)
POOL_MEMBER_MOD = load_clvm_maybe_recompile("pool_member_innerpuz.clsp", package_or_requirement="wheat.pools.puzzles")
