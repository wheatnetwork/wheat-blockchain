...
from wheat.rpc.farmer_rpc_api import PlotInfoRequestData, PlotPathRequestData
from wheat.rpc.rpc_client import RpcClient
from wheat.types.blockchain_format.sized_bytes import bytes32
from wheat.util.misc import dataclass_to_json_dict


class FarmerRpcClient(RpcClient):
    """
    Client to Wheat RPC, connects to a local farmer. Uses HTTP/JSON, and converts back from
