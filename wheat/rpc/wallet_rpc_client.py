...
from wheat.data_layer.data_layer_wallet import Mirror, SingletonRecord
from wheat.pools.pool_wallet_info import PoolWalletInfo
...
from wheat.wallet.conditions import Condition, ConditionValidTimes, conditions_to_json_dicts
...
from wheat.wallet.util.query_filter import TransactionTypeFilter
...
from wheat.wallet.vc_wallet.vc_store import VCRecord
...
class WalletRpcClient(RpcClient):
    """
    Client to Wheat RPC, connects to a local wallet. Uses HTTP/JSON, and converts back from
    JSON into native python objects before returning. All api calls use POST requests.
    Note that this is not the same as the peer protocol, or wallet protocol (which run Wheat's
    ...
    async def nft_mint_bulk(
        ...
        wheat_coins: Optional[List[Dict]] = None,
        wheat_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "wheat_change_target": wheat_change_target,
