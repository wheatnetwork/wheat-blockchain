...
from wheat.data_layer.data_layer_errors import OfferIntegrityError
...
from wheat.data_layer.data_layer_wallet import DataLayerWallet, Mirror, verify_offer
from wheat.rpc.data_layer_rpc_util import marshal
...
if TYPE_CHECKING:
    from wheat.data_layer.data_layer import DataLayer
...
class DataLayerRpcApi:
    ...
    def __init__(self, data_layer: DataLayer):  # , wallet: DataLayerWallet):
        ...
        self.service_name = "wheat_data_layer"
