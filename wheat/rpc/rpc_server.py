...
from wheat.rpc.util import wrap_http_handler
from wheat.server.outbound_message import NodeType
from wheat.server.server import WheatServer, ssl_context_for_client, ssl_context_for_server
...
from wheat.util.config import str2bool
from wheat.util.ints import uint16
from wheat.util.json_util import dict_to_json_str
from wheat.util.network import WebServer, resolve
from wheat.util.ws_message import WsRpcMessage, create_payload, create_payload_dict, format_response, pong
...
class RpcServiceProtocol(Protocol):
    ...
    def server(self) -> WheatServer:
        ...
        # a property so as to be read only which allows WheatServer to satisfy
        # Optional[WheatServer]
        ...
    ...
    def get_connections(self, request_node_type: Optional[NodeType]) -> List[Dict[str, Any]]:
        ...
        wheat.rpc.rpc_server.default_get_connections()
        """
        ...
...
def default_get_connections(server: WheatServer, request_node_type: Optional[NodeType]) -> List[Dict[str, Any]]:
