"""
NOTE: This contains duplicate code from `wheat.cmds.plots`.
After `wheat plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_wheatpos_install_info() -> Optional[Dict[str, Any]]:
    wheatpos_version: str = pkg_resources.get_distribution("chiapos").version
    return {"display_name": "Wheat Proof of Space", "version": wheatpos_version, "installed": True}
