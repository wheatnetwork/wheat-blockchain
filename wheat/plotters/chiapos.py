...
from wheat.plotting.util import Params, add_plot_directory, validate_plot_size
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Wheat Proof of Space", "version": chiapos_version, "installed": True}


def plot_wheat(args: Namespace, root_path: Path) -> None:
    try:
