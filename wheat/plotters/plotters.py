...
from wheat.plotters.wheatpos import get_wheatpos_install_info, plot_wheat
from wheat.plotters.madmax import get_madmax_install_info, plot_madmax
from wheat.plotters.install_plotter import install_plotter
...
def build_parser(subparsers, root_path, option_list, name, plotter_desc):
    ...
    for option in option_list:
        ...
        u_default = 0 if name == "wheatpos" else 256
...
def call_plotters(root_path: Path, args):
    ...
    build_parser(subparsers, root_path, wheat_plotter, "wheatpos", "Wheatpos Plotter")
...
def get_available_plotters(root_path) -> Dict[str, Any]:
    ...
    wheatpos: Optional[Dict[str, Any]] = get_wheatpos_install_info()
    ...
    if wheatpos is not None:
        plotters["wheatpos"] = wheatpos
