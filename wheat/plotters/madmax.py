...
from wheat.plotters.plotters_util import get_venv_bin, reset_loop_policy_for_windows, run_command, run_plotter
...
def plot_madmax(args, wheat_root_path: Path, plotters_root_path: Path):
    ...
    try:
        asyncio.run(run_plotter(wheat_root_path, args.plotter, call_args, progress))
    except Exception as e:
