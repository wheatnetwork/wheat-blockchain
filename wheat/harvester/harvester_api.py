...
from wheat.plotting.util import PlotInfo, parse_plot_info
from wheat.protocols import harvester_protocol
from wheat.protocols.farmer_protocol import FarmingInfo
from wheat.protocols.harvester_protocol import Plot, PlotSyncResponse
...
from wheat.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSWheatConnection
    ) -> None:
        """
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSWheatConnection
    ) -> None:
        """
