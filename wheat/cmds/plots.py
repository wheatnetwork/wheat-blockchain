...
def show_plots(root_path: Path):
    from wheat.plotting.plot_tools import get_plot_directories
...
def create_cmd(
    ...
    from wheat.plotting.create_plots import create_plots
...
def add_cmd(ctx: click.Context, final_dir: str):
    from wheat.plotting.plot_tools import add_plot_directory
...
def remove_cmd(ctx: click.Context, final_dir: str):
    from wheat.plotting.plot_tools import remove_plot_directory
