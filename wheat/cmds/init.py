...
@click.option("--testnet", is_flag=True, help="Configure this wheat install to connect to the testnet")
...
def init_cmd(ctx: click.Context, create_certs: str, fix_ssl_permissions: bool, testnet: bool, **kwargs):
    ...
    from wheat.cmds.passphrase_funcs import initialize_passphrase
