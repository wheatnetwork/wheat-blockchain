...
from wheat.util.collection import find_duplicates
from wheat.util.db_synchronous import db_synchronous_on
from wheat.util.db_wrapper import DBWrapper2, execute_fetchone
from wheat.util.pprint import print_compact_ranges
...
help_text = """
\b
    The purpose of this command is find potential issues in Wheat wallet databases.
    The core wheat client currently uses sqlite to store the wallet databases, one database per key.
\b
