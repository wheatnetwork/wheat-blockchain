...
from wheat.cmds.show_funcs import show_async
...
def show_cmd(
    ...
    if connections:
        print("'wheat show -c' has been renamed to 'wheat peer full_node -c' ")
    if add_connection != "":
        print("'wheat show -a' has been renamed to 'wheat peer full_node -a' ")
    if remove_connection != "":
        print("'wheat show -r' has been renamed to 'wheat peer full_node -r' ")
    if wallet_rpc_port is not None:
        print("'wheat show -wp' is not used, please remove it from your command.")
    asyncio.run(
        show_async(
            rpc_port,
            ctx.obj["root_path"],
