...
def generate(shell: str) -> None:
    ...
    You can source it directly (performs slower) by running:
        \033[3;33meval "$(wheat complete generate)"\033[0m
    or you can save the output to a file:
        \033[3;33mwheat complete generate > ~/.wheat-complete-bash\033[0m
    and source that file with:
        \033[3;33m. ~/.wheat-complete-bash\033[0m
    """
    ...
    subprocess.run(["wheat"], check=True, env={**os.environ, "_WHEAT_COMPLETE": f"{shell}_source"})
