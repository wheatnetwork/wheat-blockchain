...
from wheat.util.misc import format_bytes, format_minutes
from wheat.util.network import is_localhost
...
async def summary(
    ...
    if amounts is not None:
        print(f"Total wheat farmed: {amounts['farmed_amount'] / units['wheat']}")
        print(f"User transaction fees: {amounts['fee_amount'] / units['wheat']}")
        print(f"Block rewards: {(amounts['farmer_reward_amount'] + amounts['pool_reward_amount']) / units['wheat']}")
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'wheat start wallet' and 'wheat wallet show'")
        elif wallet_not_ready:
            print("For details on farmed rewards and fees you should run 'wheat wallet show'")
    else:
        print("Note: log into your key using 'wheat wallet show' to see rewards for each key")
