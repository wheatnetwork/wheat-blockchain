...
from wheat.cmds.cmds_util import tx_config_args
...
@click.option(
    "--proposal-minimum",
    help="The minimum amount (in wheat) that a proposal must use to be created",
    type=str,
...
@click.option(
    "--fee-for-cat",
    help="Set the fees for the CAT creation transaction, in WHEAT.",
    type=str,
    default="0",
    show_default=True,
    callback=validate_fee,
...
@click.option(
    "--asset-id",
    help="The asset id of the funds the proposal will send. Leave blank for wheat",
    type=str,
    required=False,
    default=None,
)
