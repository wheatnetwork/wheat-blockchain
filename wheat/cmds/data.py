...
def create_data_store(
    ...
    from wheat.cmds.data_funcs import create_data_store_cmd
...
def get_value(
    ...
    from wheat.cmds.data_funcs import get_value_cmd
...
def update_data_store(
    ...
    from wheat.cmds.data_funcs import update_data_store_cmd
...
def get_keys(
    ...
    from wheat.cmds.data_funcs import get_keys_cmd
...
def get_keys_values(
    ...
    from wheat.cmds.data_funcs import get_keys_values_cmd
...
def get_root(
    ...
    from wheat.cmds.data_funcs import get_root_cmd
...
def subscribe(
    ...
    from wheat.cmds.data_funcs import subscribe_cmd
...
def remove_subscription(
    ...
    from wheat.cmds.data_funcs import remove_subscriptions_cmd
...
def unsubscribe(
    ...
    from wheat.cmds.data_funcs import unsubscribe_cmd
...
def get_kv_diff(
    ...
    from wheat.cmds.data_funcs import get_kv_diff_cmd
...
def get_root_history(
    ...
    from wheat.cmds.data_funcs import get_root_history_cmd
...
def add_missing_files(
    ...
    from wheat.cmds.data_funcs import add_missing_files_cmd
...
def add_mirror(
    ...
    from wheat.cmds.data_funcs import add_mirror_cmd
...
def delete_mirror(
    ...
    from wheat.cmds.data_funcs import delete_mirror_cmd
...
def get_mirrors(
    ...
    from wheat.cmds.data_funcs import get_mirrors_cmd
...
def get_subscriptions(
    ...
    from wheat.cmds.data_funcs import get_subscriptions_cmd
...
def get_owned_stores(
    ...
    from wheat.cmds.data_funcs import get_owned_stores_cmd
...
def get_sync_status(
    ...
    from wheat.cmds.data_funcs import get_sync_status_cmd
...
def check_plugins(
    ...
    from wheat.cmds.data_funcs import check_plugins_cmd
...
def clear_pending_roots(
    ...
    from wheat.cmds.data_funcs import clear_pending_roots
...
def wallet_log_in(
    ...
    from wheat.cmds.data_funcs import wallet_log_in_cmd
