...
from wheat.util.keychain import Keychain, bytes_to_mnemonic, generate_mnemonic, mnemonic_to_seed, unlocks_keyring
...
def _search_derived(
    ...
    for index in range(limit):
        ...
        if search_address:
            ...
            address = encode_puzzle_hash(create_puzzlehash_for_pk(child_pk), "wheat")
