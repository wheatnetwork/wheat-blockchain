    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "23333"
                testnet_introducer = "introducer-testnet0.wheatcoin.top"
                testnet_dns_introducer = "dns-introducer-testnet0.wheatcoin.top"
                bootstrap_peers = ["testnet0-node.wheatcoin.top"]
                testnet = "testnet0"
                ...
                mainnet_dns_introducer = "dns.wheatcoin.top"
        ...
        if change_made:
            print("Restart any running wheat services for changes to take effect")
