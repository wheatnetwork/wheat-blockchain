...
from wheat.util.db_version import set_db_version
...
def wheat_init(
    ...
    *,
    ...
    """
    wheat_root = os.environ.get("WHEAT_ROOT", None)
    if wheat_root is not None:
        print(f"WHEAT_ROOT is set to {wheat_root}")
