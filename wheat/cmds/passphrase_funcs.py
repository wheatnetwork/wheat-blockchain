...
from wheat.util.keychain import Keychain, obtain_current_passphrase, supports_os_passphrase_storage
from wheat.util.keyring_wrapper import DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE
from wheat.util.misc import prompt_yes_no
from wheat.util.ws_message import WsRpcMessage
    ...
    try:
        if supports_os_passphrase_storage():
            ...
            print(
                ...
                "Other Wheat processes will be able to access your keys without prompting for your passphrase."
            )
...
def read_passphrase_from_file(passphrase_file: TextIOWrapper) -> str:
    passphrase = passphrase_file.read().rstrip(os.environ.get("WHEAT_PASSPHRASE_STRIP_TRAILING_CHARS", "\r\n"))
...
def initialize_passphrase() -> None:
    if Keychain.has_master_passphrase():
        ...
        print("\nUse 'wheat passphrase set' or 'wheat passphrase remove' to update or remove your passphrase")
        sys.exit(1)
