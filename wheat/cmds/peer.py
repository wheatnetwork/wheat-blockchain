...
from wheat.cmds.cmds_util import NODE_TYPES
from wheat.cmds.peer_funcs import peer_async
...
@click.option("-a", "--add-connection", help="Connect specified Wheat service to ip:port", type=str, default="")
@click.option(
