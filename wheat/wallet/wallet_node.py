...
from wheat.types.weight_proof import SubEpochData, WeightProof
...
from wheat.util.keychain import Keychain, KeyringIsLocked
    ...
    def initialize_wallet_peers(self):
        ...
        if self.wallet_peers is None and connect_to_unknown_peers and not testing:
            self.wallet_peers = WalletPeers(
                ...
                self.config.get("dns_servers", ["dns-introducer.wheat.top"]),
