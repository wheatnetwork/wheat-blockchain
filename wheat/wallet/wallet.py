...
from wheat.wallet.puzzles.clawback.metadata import ClawbackMetadata
...
from wheat.wallet.puzzles.puzzle_utils import (
...
from wheat.wallet.util.wallet_types import WalletIdentifier, WalletType
...
class Wallet:
    ...
    async def sign_message(self, message: str, puzzle_hash: bytes32, mode: SigningMode) -> Tuple[G1Element, G2Element]:
        ...
        # https://github.com/Wheat-Network/chips/blob/80e4611fe52b174bf1a0382b9dff73805b18b8c6/CHIPs/chip-0002.md#signmessage
    ...
    async def create_tandem_wheat_tx(
        ...
        wheat_coins = await self.select_coins(fee, tx_config.coin_selection_config)
        [wheat_tx] = await self.generate_signed_transaction(
            uint64(0),
    ...
    # WSWheatConnection is only imported for type checking
