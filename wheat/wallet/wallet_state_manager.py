...
from wheat.pools.pool_puzzles import SINGLETON_LAUNCHER_HASH, solution_to_pool_state
from wheat.pools.pool_wallet import PoolWallet
from wheat.protocols import wallet_protocol
from wheat.protocols.wallet_protocol import CoinState, PuzzleSolutionResponse, RespondPuzzleSolution
...
from wheat.util.config import process_config_start_method
...
from wheat.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_wallet_sk_unhardened
from wheat.wallet.did_wallet.did_info import DID_HRP
from wheat.wallet.did_wallet.did_wallet import DIDWallet
from wheat.wallet.did_wallet.did_wallet_puzzles import DID_INNERPUZ_MOD, create_fullpuz, match_did_puzzle
from wheat.wallet.key_val_store import KeyValStore
from wheat.wallet.nft_wallet.nft_info import NFTWalletInfo
...
from wheat.wallet.rl_wallet.rl_wallet import RLWallet
from wheat.wallet.settings.user_settings import UserSettings
...
from wheat.wallet.util.wallet_sync_utils import last_change_height_cs
from wheat.wallet.util.wallet_types import WalletType
from wheat.wallet.wallet import Wallet
from wheat.wallet.wallet_action import WalletAction
from wheat.wallet.wallet_action_store import WalletActionStore
...
from wheat.wallet.wallet_sync_store import WalletSyncStore
...
from wheat.wallet.wallet_weight_proof_handler import WalletWeightProofHandler
...
class WalletStateManager:
    ...
    async def new_coin_state(
        self, coin_states: List[CoinState], peer: WSWheatConnection, fork_height: Optional[uint32]
    ) -> None:
