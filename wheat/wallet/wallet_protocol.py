...
from wheat.wallet.nft_wallet.nft_info import NFTCoinInfo
from wheat.wallet.util.tx_config import CoinSelectionConfig
...
class WalletProtocol(Protocol[T]):
    ...
    async def coin_added(self, coin: Coin, height: uint32, peer: WSWheatConnection, coin_data: Optional[T]) -> None:
        ...
