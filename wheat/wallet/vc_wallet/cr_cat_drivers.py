...
from wheat.wallet.cat_wallet.cat_utils import CAT_MOD, construct_cat_puzzle
...
from wheat.wallet.puzzles.singleton_top_layer_v1_1 import SINGLETON_LAUNCHER_HASH, SINGLETON_MOD_HASH
from wheat.wallet.uncurried_puzzle import UncurriedPuzzle, uncurry_puzzle
from wheat.wallet.util.curry_and_treehash import curry_and_treehash
from wheat.wallet.vc_wallet.vc_drivers import (
    COVENANT_LAYER_HASH,
...
CREDENTIAL_RESTRICTION: Program = load_clvm_maybe_recompile(
    ...
    package_or_requirement="wheat.wallet.vc_wallet.cr_puzzles",
...
class CRCAT:
    ...
    def launch(
        ...
        """
        Launch a new CR-CAT from WHEAT.
