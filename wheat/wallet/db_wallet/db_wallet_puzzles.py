...
from wheat.wallet.nft_wallet.nft_puzzles import NFT_STATE_LAYER_MOD, create_nft_layer_puzzle_with_curry_params
from wheat.wallet.puzzles.load_clvm import load_clvm_maybe_recompile

# from wheat.types.condition_opcodes import ConditionOpcode
# from wheat.wallet.util.merkle_tree import MerkleTree, TreeType
...
GRAFTROOT_DL_OFFERS = load_clvm_maybe_recompile(
    "graftroot_dl_offers.clsp", package_or_requirement="wheat.data_layer.puzzles"
)
