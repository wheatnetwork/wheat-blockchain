...
from wheat.types.blockchain_format.coin import hash_coin_list, Coin
...
async def request_and_validate_removals(
    peer: WSWheatConnection, height: uint32, header_hash: bytes32, coin_name: bytes32, removals_root: bytes32
) -> bool:
