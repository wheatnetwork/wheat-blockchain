...
NFT_METADATA_UPDATER = load_clvm_maybe_recompile(
    "nft_metadata_updater_default.clsp", package_or_requirement="wheat.wallet.nft_wallet.puzzles"
)
NFT_OWNERSHIP_LAYER = load_clvm_maybe_recompile(
    "nft_ownership_layer.clsp", package_or_requirement="wheat.wallet.nft_wallet.puzzles"
)
...
NFT_TRANSFER_PROGRAM_DEFAULT = load_clvm_maybe_recompile(
    ...
    package_or_requirement="wheat.wallet.nft_wallet.puzzles",
)
...
INTERMEDIATE_LAUNCHER_MOD = load_clvm_maybe_recompile(
    "nft_intermediate_launcher.clsp", package_or_requirement="wheat.wallet.nft_wallet.puzzles"
)
