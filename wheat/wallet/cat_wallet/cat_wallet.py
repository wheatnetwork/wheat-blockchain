...
from wheat.wallet.puzzles.genesis_checkers import ALL_LIMITATIONS_PROGRAMS
                ...
                if need_wheat_transaction:
                    if fee > regular_wheat_to_claim:
                        wheat_tx, _ = await self.create_tandem_wheat_tx(
                            fee, uint64(regular_wheat_to_claim), announcement_to_assert=announcement
                        )
                        ...
                        wheat_tx, _ = await self.create_tandem_wheat_tx(fee, uint64(regular_wheat_to_claim))
                        innersol = self.standard_wallet.make_solution(
                            primaries=primaries,
                            coin_announcements={announcement.message},
