...
class KeyringWrapper:
    ...
    def set_master_passphrase(
        ...
        from wheat.util.keychain import KeyringCurrentPassphaseIsInvalid, KeyringRequiresMigration
    ...
    def migrate_legacy_keyring(self):
        ...
        from wheat.util.keychain import Keychain, MAX_KEYS
    ...
    def confirm_legacy_keyring_cleanup(self, legacy_keyring, service, users):
        ...
        # [wheat_2Duser_2Dwheat_2D1_2E8] is left behind
