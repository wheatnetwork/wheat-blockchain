...
dependencies = [
    ...
    "setproctitle==1.3.3",  # Gives the wheat processes readable names
...
kwargs = dict(
    ...
    author="hello",
    author_email="hello@wheatcoin.top",
    ...
    packages=find_packages(include=["build_scripts", "wheat", "wheat.*", "mozilla-ca"]),
    entry_points={
        "console_scripts": [
